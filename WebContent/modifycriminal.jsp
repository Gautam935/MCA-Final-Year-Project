...
<s:form action="modifyCriminal.action" >
<table  background="./police1_files/bg2.gif"    width="750">
<tr><td></td>
        <td><h1>Welcome to the Criminals Modification</h1></td>
    </tr>
<tr><td><s:textfield name="firnumber" label="FIR NUMBER" /></td></tr>
<tr><td><s:textfield name="criminalname" label="CRIMINAL NAME" /></td></tr>
<tr><td><s:textfield name="fathername" label="FATHER NAME" /></td></tr>
<tr><td><s:textfield name="age" label="AGE" /></td></tr>
<tr><td><s:radio label="GENDER" name="gender" list="{'male','female'}" /></td></tr>
<tr><td><s:select name="crimetype" label="CRIME TYPE" list="{'Civil','Theft','Murder','others'}" /></td></tr>
<tr><td><sx:datetimepicker label="Custody Date (dd/MM/yyyy)" name="custodydate"></sx:datetimepicker></td></tr>

<tr><td><s:submit value="submit" align="center"/></td></tr>
<s:a href="representativesWelcome.jsp">Back</s:a>
        </table>
        </s:form>
  </center>
  </td>
