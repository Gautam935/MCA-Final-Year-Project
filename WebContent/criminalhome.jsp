...
<td align="right">&nbsp;
<center>
<h1>Welcome to the Criminals Monitoring </h1>
<h3><s:a href="addcriminal.jsp">Add Criminal Records</s:a><br/></h3>
<h3><s:a href="modifycriminal.jsp">Modify Criminal Records</s:a></h3>
  </center>
  </td>
