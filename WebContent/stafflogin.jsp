...
<th><a class="tab" href="notificationsView.jsp"><font face="Century Gothic">Recruitment</font></a></th>
...
<s:form action="stafflogin.action" >
    <table  background="./police1_files/bg2.gif"    width="750">
   
    <tr><td></td>
        <td><h1>Welcome to the Staff Login</h1></td>
    </tr>
 <tr>
<td><s:textfield name="name" label="USER NAME"/></td>
</tr>
 <tr>
<td><s:password name="password" label="Password"></s:password>
</tr>

<tr>
<td><s:submit  value="Submit" align="center"/></td>
</tr>
<tr><td><h3><s:a href="staffregistration.jsp" >New Staff</s:a></h3></td></tr>
