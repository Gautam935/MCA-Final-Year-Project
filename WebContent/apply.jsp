...
<tr><td></td>
        <td><h1>Welcome to the Jobs Updation</h1></td>
    </tr>
...
<tr><td><s:select name="qualification" label="QUALIFICATION" list="{'Secondary','Inter','Degree','Post Degree'}" /></td></tr>
<tr><td><sx:datetimepicker label="Date of Birth (dd/MM/yyyy)" name="dateofbirth"></sx:datetimepicker></td></tr>
<tr><td><s:file name="path" label="Upload Resume"></s:file></td></tr>
