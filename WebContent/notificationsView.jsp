...
<table border="1" style="background-color: white;width: 600px;margin-bottom: 500px;">
         <tr><th>POST NAME</th><th>QUALIFICATION</th><th>AGE</th><th>CUT OFF</th><th>START DATE</th><th>END DATE</th></tr>
         <tr>
      <td>   <s:iterator value="arrayList1"><s:property/><br></br></s:iterator></td>
      <td>   <s:iterator value="arrayList2"><s:property/><br></br></s:iterator></td>
      <td>   <s:iterator value="arrayList3"><s:property/><br></br></s:iterator></td>
      <td>   <s:iterator value="arrayList4"><s:property/><br></br></s:iterator></td>
      <td>   <s:iterator value="arrayList5"><s:property/><br></br></s:iterator></td>
      <td>   <s:iterator value="arrayList6"><s:property/><br></br></s:iterator></td>
      
      </tr>     
      <tr><s:a href="apply.jsp">Apply</s:a></tr>
         </table>
  </center>
  </td>
