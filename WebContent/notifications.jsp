...
<s:form action="notifications.action" >
<table  background="./police1_files/bg2.gif"    width="750">
<tr><td></td>
        <td><h1>Welcome to the Notifications</h1></td>
    </tr>
<tr><td><s:textfield name="postname" label="POST NAME" /></td></tr>
<tr><td><s:textfield name="qualification" label="QUALIFICATION" /></td></tr>
<tr><td><s:textfield name="age" label="AGE" /></td></tr>
<tr><td><s:textfield name="cutoff" label="CUT OFF" /></td></tr>

<tr><td><sx:datetimepicker label="Start Date (dd/MM/yyyy)" name="startdate"></sx:datetimepicker></td></tr>
<tr><td><sx:datetimepicker label="End Date (dd/MM/yyyy)" name="enddate"></sx:datetimepicker></td></tr>
<tr><td><s:submit value="submit" align="center"/></td></tr>
<s:a href="representativesWelcome.jsp">Back</s:a><br/>
<s:a href="updateNotification.jsp">Show Notification</s:a>
        </table>
        </s:form>
  </center>
  </td>
